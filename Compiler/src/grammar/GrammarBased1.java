...
public class GrammarBased1 {
    ...
    public static void main(String args[]){
        ...
        String source[] = {"int"," ", "a", "=", "29", ";"};
        
//        String source[] = {"int"," ", "a", ";"};        
//        String source[] = {"int"," ", "a", ",", "b", ";"};
//        String source[] = {"int"," ", "a", ",", "b", ",", "c", ";"};
//        String source[] = {"int"," ", "a", "=", "b", "+", "29", ";"};
//        String source[] = {"int"," ", "a", "=", "32", "+", "29", ";"};
//        String source[] = {"int"," ", "a", "=", "32", "+", "29", "+", "b", ";"};
...
//        String source[] = {"int"," ", "a", "=", "29"};
        ...
        tokenList.addAll(Arrays.asList(source));
        print(tokenList+"");
        print("Parse status : "+startParsing());
